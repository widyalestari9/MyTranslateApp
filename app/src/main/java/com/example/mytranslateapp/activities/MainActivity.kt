...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val arrayBahasa =
            ArrayAdapter(this@MainActivity, android.R.layout.simple_list_item_1, strBahasa)
        arrayBahasa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
        spinnerBahasa.setAdapter(arrayBahasa)
        spinnerBahasa.setOnItemSelectedListener(object : AdapterView.OnItemSelectedListener {
        ...
        fabVoice.setOnClickListener {
            ...
            try {
                ...
                Toast.makeText(this@MainActivity, "Ups! Terjadi kesalahan", Toast.LENGTH_SHORT)
                    .show()
            }
        }
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                override fun onResponse(response: JSONObject) {
                    ...
                    try {
                        ...
                        Toast.makeText(
                            this@MainActivity,
                            "Oops, gagal menampilkan jenis dokumen.",
                            Toast.LENGTH_SHORT
                        ).show()
                    }
                }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == Companion.REQUEST_CODE_SPEECH_INPUT) {
            if (requestCode != RESULT_OK && null != data) {
                ...
                teksInput.setText(result?.get(0))
            }
        }
    }
